    ...
    <div className="adm-dashboard-container">
      ...
      <div className="adm-dashboard-header">
        <div className="adm-header-text">
          <h1 className="adm-dashboard-title">Manage and Monitor Community Policy Infractions</h1>
        </div>
        <div className="adm-datetime-section">
          <div className="adm-date-section">
      ...
      <div className="adm-kpi-grid">
        ...
        <div className="adm-kpi-card">
          ...
          <div className="adm-kpi-content">
            <span className="adm-kpi-value">{kpis.totalResidents}</span>
            <span className="adm-kpi-label">Total Residents</span>
          </div>
        </div>
        ...
        <div className="adm-kpi-card">
          ...
          <div className="adm-kpi-content">
            <span className="adm-kpi-value">{kpis.pendingPayment}</span>
            <span className="adm-kpi-label">Pending Payments</span>
          </div>
        </div>
        ...
        <div className="adm-kpi-card">
          ...
          <div className="adm-kpi-content">
            <span className="adm-kpi-value">{kpis.pendingBill}</span>
            <span className="adm-kpi-label">Pending Bills</span>
          </div>
        </div>
        ...
        <div className="adm-kpi-card">
          ...
          <div className="adm-kpi-content">
            <span className="adm-kpi-value">{kpis.pendingViolation}</span>
            <span className="adm-kpi-label">Pending Violations</span>
          </div>
        </div>
      </div>
      ...
      <div className="adm-pending-sections-row">
        ...
        <div className="adm-section-header">
          <h3>Pending Bills</h3>
          <a href="/billing" className="adm-view-all-link">View All</a>
        </div>
        {pendingBills.length > 0 ? (
          <div className="adm-bills-table-container" style={{ flex: 1 }}>
            <table className="adm-bills-table">
              <thead>
                <tr>
                  <th>Resident</th>
                  <th>Type</th>
              ...
              <tbody>
                {pendingBills.slice(0, 6).map((bill) => (
                  <tr key={bill.id || bill.bill_id}>
                    ...
                    <td>
                      <span className={`adm-status-badge bill-${bill.status?.toLowerCase() || 'pending'}`}>{bill.status || 'Pending'}</span>
                    </td>
                  </tr>
                ))}
              </tbody>
          ...
          <div className="adm-empty-message">No pending bills</div>
        )}
        </div>

        {/* Pending Violations Section */}
        <div className="adm-pending-violations-section">
        <div className="adm-section-header">
        ...
        {pendingViolations.length > 0 ? (
              ...
              <tbody>
                {pendingViolations.slice(0, 6).map((violation) => (
                  <tr key={violation.id || violation.violation_id}>
                    ...
                    <td>
                      <span className={`adm-status-badge ${violation.status?.toLowerCase() || 'pending'}`}>{violation.status || 'Pending'}</span>
                    </td>
                  </tr>
                ))}
              </tbody>
          ...
          <div className="adm-empty-message">No pending violations</div>
        )}
        </div>
      </div>
      ...
      <div className="adm-charts-section">
        ...
        <div className="adm-chart-card">
          ...
          <div className="adm-violation-chart-container">
            <svg viewBox="0 0 400 200" style={{ width: '100%', height: '100%' }}>
              ...
              {violationStats.length > 0 && (() => {
                ...
                const step = width / (violationStats.length - 1 || 1);
                ...
                const xLabels = violationStats.filter((_, i) => i % labelStep === 0 || i === violationStats.length - 1);
          ...
          <div className="adm-chart-summary">
            <span className="adm-total-violations">Total: {violationTotal} violations</span>
          </div>
        </div>
        ...
        <div className="adm-chart-card">
          <div className="adm-chart-header">
            ...
            <a href="/residents" className="adm-chart-link">View</a>
          </div>
      ...
      <div className="adm-quick-actions-section">
        <h3 className="adm-quick-actions-title">Quick Actions</h3>
        <div className="adm-quick-actions-grid">
          <a href="/residents?action=add" className="adm-quick-action-card">
            ...
            <span className="adm-quick-action-label">Add Resident</span>
          </a>
          
          <a href="/billing?action=create" className="adm-quick-action-card">
            <div className="adm-quick-action-icon">
            ...
            <span className="adm-quick-action-label">Create Bill</span>
          </a>
          
          <a href="/violations?action=add" className="adm-quick-action-card">
            <div className="adm-quick-action-icon">
            ...
            <span className="adm-quick-action-label">Record Violation</span>
          </a>
          
          <a href="/reports" className="adm-quick-action-card">
            <div className="adm-quick-action-icon">
            ...
            <span className="adm-quick-action-label">View Reports</span>
          </a>
          
          <a href="/payments" className="adm-quick-action-card">
            <div className="adm-quick-action-icon">
            ...
            <span className="adm-quick-action-label">Manage Payments</span>
          </a>
        </div>
      </div>
    </div>
